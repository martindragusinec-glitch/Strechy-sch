...
- **Kalkulačka nároku `#narok`:** metodika oficiálního nástroje SFŽP „příjmové decily“ v1.2 (24. 6. 2026, EU-SILC 2025): hranice všech 10 decilů, spotřební jednotky 1 + 0,5·(dospělí−1) + 0,5·děti 14–17 + 0,3·děti do 13, 3. decil / 5. decil (všichni dospělí v důchodu nebo ID 3. st.), superdávka = nárok vždy. Příjmy měsíčně čisté (průměr 3 měsíce): OSVČ z roční fakturace s paušálem **70 %** (zadání 21. 9.; zisk − daň 15 % po slevě − minimální pojistné 2026) nebo přepnutím na roční čistý zisk z DP ÷ 12; dále výplaty, důchody, dávky, jiné. Výstup: verdikt, stupnice 1–10, tři řádky jako u SFŽP (dotace NZÚ Light, úvěr 25 let pro decil < 5, renovační pas zdarma), rozbalovací „Co si připravit“. Nic se neposílá, výsledek jde do leadu (`note_fields['Kalkulačka nároku OSVČ']`, `extra.elig_calc`) a při kliku na CTA `eligibility_calc` do dataLayer. Zdrojová oficiální kalkulačka: `~/Downloads/nzu-podrobny-vypocet.html` (klient, 21. 9.).
